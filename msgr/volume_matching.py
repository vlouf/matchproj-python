...
def process(nprof, ntilt, reflectivity_satellite, reflectivity_ground_radar, refp_ss, refp_sh, refg_ku,
            xp, yp, zp, ep, rg, xg, yg, elang, bwr, dr, drt, alpha, earth_gaussian_radius):
    ...
    volg = 1e-9 * np.pi * dr * (np.pi / 180 * bwr / 2 * rg)**2
    ...
    return x, y, z, dz, ds, r, ref1, ref2, ref3, ref4, ref5, iref1, iref2, stdv1, stdv2, ntot1, nrej1, ntot2, nrej2
